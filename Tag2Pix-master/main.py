...
def parse_args():
    ...
    parser.add_argument('--thread', type=int, default=4, help='total thread count of data loader')
    parser.add_argument('--epoch', type=int, default=20, help='The number of epochs to run')

    parser.add_argument('--batch_size', type=int, default=64, help='Total batch size')
    parser.add_argument('--input_size', type=int, default=32, help='Width / Height of input image (must be rectangular)')
    ...
    parser.add_argument('--l2_lambda', type=float, default=12000, help='Coefficient of content loss')
    ...
    # parser.add_argument('--layers', type=int, nargs='+', default=[6,4,3,3],
        # help='Block counts of each U-Net Decoder blocks of generator. The first argument is count of bottom block.')
    parser.add_argument('--layers', type=int, nargs='+', default=[1, 1, 1, 1],
                        help='Block counts of each U-Net Decoder blocks of generator. The first argument is count of bottom block.')
    '''
