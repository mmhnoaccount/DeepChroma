...
class Generator(nn.Module):
    def __init__(self, luma_size, chroma_size, ref_length, luma_dim=3, output_dim=2,
        ...
        self.conv1 = self._make_encoder_block_first(self.luma_dim, 16)
    ...
    def forward(self, luma_in, chroma_in, Ref_in):
        out1 = self.conv1(luma_in)
        ...
        Ref_tensor = self.colorFC(Ref_in)
        ...
        '''
        #print('out.shape:', out5.shape)
        #print('chroma_tensor.shape:', chroma_tensor.shape)
...
if __name__ == '__main__':
    ...
    temp2 = torch.zeros(1, 4, 32, 32)
    temp3 = torch.zeros(1, 2, 32, 32)
    temp4 = torch.zeros(1, 128)
    G = Generator(luma_size=32, chroma_size=32, ref_length=128, luma_dim=4, output_dim=2)
